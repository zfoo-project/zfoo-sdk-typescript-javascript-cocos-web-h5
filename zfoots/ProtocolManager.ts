...
import JProtobufHelloRequest from './jprotobuf/JProtobufHelloRequest';
import JProtobufHelloResponse from './jprotobuf/JProtobufHelloResponse';
...
protocols.set(1500, JProtobufHelloRequest);
protocols.set(1501, JProtobufHelloResponse);
